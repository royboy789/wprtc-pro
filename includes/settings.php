        ...
        echo '<table width="100%" cellpadding="5" cellspacing="5" border="0">';
            echo '<tr>';
				echo '<td width="50%" valign="top">';
                    ...
                    echo '<p><code>[wpRTC room_name="testing, testingAgain, anotherRoom"]</code> - <em>This feature adds in a drop down box under the video so users can change rooms using the same page and video code. wpRTC PRO</em></p>';
                    // privacy
                ...
                echo '<td valign="top">';
                    ...
                    echo '<ul>';
                        ...
                        echo '<li><strong>Support</strong> <br/> Preferred support - <a target="_blank" href="http://www.roysivan.com/plugin-support">Plugin Support Page</a></li>';
                    echo '</ul>';
                    echo '<h3><strong>Thank You</strong> - for purchasing wpRTC Pro</h3>';
                echo '</td>';
            echo '</tr>';
        echo '</table>';
    echo '</div>';
